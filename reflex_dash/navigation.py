...
from reflex_dash.styles import FONT_FAMILY
...
dashboard_sidebar = sidebar(
    ...
    sidebar_link(text="API", href="/tools", icon="settings"),
    sidebar_link(text="Feedback", href="/team", icon="users"),
    # logo_src="/logo.jpg",
    heading="PROPERTYDATA",
)
